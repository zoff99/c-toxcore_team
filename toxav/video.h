...
#define TOXAV_ENCODER_VP8_RC_MAX_QUANTIZER_NORMAL 63
#define TOXAV_ENCODER_VP8_RC_MAX_QUANTIZER_HIGH 45
#define TOXAV_ENCODER_VP8_RC_MIN_QUANTIZER_NORMAL 10
...
#define VPX_MAX_DIST_NORMAL (15)
#define VPX_MAX_DIST_START (15)
