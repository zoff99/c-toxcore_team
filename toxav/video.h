...
#define VIDEO_RINGBUFFER_BUFFER_ELEMENTS (7) // this buffer has normally max. 1 entry
#define VIDEO_RINGBUFFER_FILL_THRESHOLD (2) // start decoding at lower quality
#define VIDEO_RINGBUFFER_DROP_THRESHOLD (4) // start dropping incoming frames (except index frames)
