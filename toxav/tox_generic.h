...
#define VIDEO_BITRATE_AUTO_INC_THRESHOLD 1.0
#define VIDEO_BITRATE_AUTO_DEC_THRESHOLD 2.5
// increase video bitrate by n%
#define VIDEO_BITRATE_AUTO_INC_TO 1.06
#define VIDEO_BITRATE_AUTO_DEC_FACTOR 0.9
